...
TestBezierPatch::TestBezierPatch()
{
    // constructor
}
...
int TestBezierPatch::init()
{
    return 0;
}

int TestBezierPatch::run()
{
    try {
...
void TestBezierPatch::BP_ParameterizedConstructor()
{
...
void TestBezierPatch::BP_IndexOperatorConst()
{
...
void TestBezierPatch::BP_IndexOperator()
{
...
void TestBezierPatch::BP_RightMatMult()
{
